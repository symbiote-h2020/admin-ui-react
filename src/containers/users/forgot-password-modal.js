...
import { FORGOT_PASSWORD_MODAL } from "../../reducers/modal/modal-reducer";
...
class ForgotPasswordModal extends Component {
    ...
    open() {
        this.props.changeModalState(FORGOT_PASSWORD_MODAL, true);
    }

    close() {
        this.props.changeModalState(FORGOT_PASSWORD_MODAL, false);
        this.props.reset();
    ...
    render() {
        ...
        return(
            <Fragment>
                ...
                <Modal show={modalState[FORGOT_PASSWORD_MODAL]} onHide={this.close}>
